...
const CatalogList = () => {
  ...
  const showMore = (itemId) => {
    // Переход на страницу элемента по его id
  ...
  //     (filters.hasAC ? item.hasAC === true : true) &&
  //     (filters.automatic ? item.automatic === true : true) &&
  //     (filters.kitchen ? item.kitchen === true : true) &&
  //     (filters.tv ? item.tv === true : true) &&
  //     (filters.bathroom ? item.bathroom === true : true)
  //   );
  // });
